/**
 * Legacy chapter slug → canonical topic slug.
 * Canonical slugs are topic-only (no pm-/pb4- prefixes); playbook scope lives in the URL path.
 */
export const LEGACY_CHAPTER_SLUGS: Record<string, string> = {
...
/** Resolve legacy or canonical slug to the canonical topic slug. */
